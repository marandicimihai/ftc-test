...
public class AutoRangers2 extends OpMode
{
...
//        angle = angle - yaw;
    ...
    public void start() {
        ...
        stop_m();
        waitt(1000);
        walkDir(0.25, 0, 0, 1000);
        stop_m();
        waitt(1000);
        walkDir(0.5, 90, 0, 3000);
        stop_m();
        waitt(500);
        walkDir(0.25, 270, 0, 1000);
        stop_m();
